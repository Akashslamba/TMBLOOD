...
class DocumentUploadView(LoginRequiredMixin, View):
    ...
    def post(self, request, pk):
        ...
        if form.is_valid():
            ...
            data = main(form.document.path)#returns string 
            data = eval(data)
            print(data)
            ...
            for item in data:
                ...
                try:
                    testresult, created = TestResult.objects.get_or_create(
                        ...
                        unit = unit,
                        value = value,
                        patient = patient,#your patient var
                        document = form
                    )
                    if created:
                        testresult.save()         
...
class GeneratedReportView(LoginRequiredMixin, View):
    ...
    def get_all_label(self, doc1=None, doc2=None, doc3=None, doc4=None, doc5=None):
        """
        return union of all labels in all five document
        """
        # do your work here 
        if doc1 is not None:
